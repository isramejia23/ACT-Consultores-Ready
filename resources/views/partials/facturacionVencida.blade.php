@php
    $diasVencidos = now()->diffInDays($cliente->fecha_facturacion);
    ...
    <div class="d-flex align-items-center">
        <div class="flex-grow-1">
            ...
            <small class="text-muted d-block">
                Venció: @formatoFecha($cliente->fecha_facturacion)
            </small>
        </div>
    </div>
</a>
        ...
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title">
                    <i class="bi bi-exclamation-triangle"></i> Notificar Facturación Vencida
                </h5>
            ...
            <div class="modal-body">
                <form action="{{ route('notificar.cliente') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <p><strong>Fecha de vencimiento:</strong> @formatoFecha($cliente->fecha_facturacion) (hace {{ round($diasVencidos) }} días)</p>
                    </div>
...
Le informamos que su plan de facturación electrónica venció el día @formatoFecha($cliente->fecha_facturacion) (hace {{ round($diasVencidos) }} días).
Por favor regularice su situación lo antes posible.</textarea>
                    </div>
<!-- 
                    <div class="mb-3">
