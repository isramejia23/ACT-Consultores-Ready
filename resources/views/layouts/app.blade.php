    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title"><i class="bi bi-whatsapp me-2"></i> Enviar mensaje por WhatsApp</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p class="text-muted small mb-2">Para: <strong id="whatsappClienteNombre"></strong></p>
                <textarea id="whatsappMensaje" class="form-control" rows="5"></textarea>
            </div>
...
<script>
    ...
    function abrirWhatsApp(clienteNombre, clienteId, obligacionId, mensajeDefault) {
        ...
        document.getElementById('whatsappMensaje').value = mensajeDefault || '';
