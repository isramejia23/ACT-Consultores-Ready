...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="bi bi-person-plus-fill text-primary me-2"></i> Crear Nuevo Cliente</h2>
    </div>
                    ...
                    <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" name="nombre_cliente" class="form-control" id="nombre_cliente" 
                                   value="{{ old('nombre_cliente') }}" required maxlength="50">
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <input type="email" name="email_cliente" class="form-control" id="email_cliente" 
                                   value="{{ old('email_cliente') }}" required maxlength="100">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-floating">
                                    <select name="regimen_id" class="form-select" id="regimen_id" required>
                                        @foreach($regimenes as $regimen)
                                            <option value="{{ $regimen->id }}" {{ old('regimen_id') == $regimen->id ? 'selected' : '' }}>
                                                {{ $regimen->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <input type="text" name="actividad" class="form-control" id="actividad" 
                                   value="{{ old('actividad') }}" maxlength="200">
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <input type="text" name="claves" class="form-control" id="claves"
                                   value="{{ old('claves') }}" maxlength="200">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="observaciones" id="observaciones" class="form-control" rows="4"
                                      maxlength="2000" placeholder="Notas internas sobre el cliente...">{{ old('observaciones') }}</textarea>
                            <div class="form-text text-end"><span id="obsCount">0</span>/2000</div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" name="saldo" class="form-control" id="saldo" 
                                           min="0" step="0.01" value="{{ old('saldo') }}">
